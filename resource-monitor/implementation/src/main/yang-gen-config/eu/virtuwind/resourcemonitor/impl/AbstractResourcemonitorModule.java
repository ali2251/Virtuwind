...
public abstract class AbstractResourcemonitorModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractResourcemonitorModule> implements eu.virtuwind.resourcemonitor.impl.ResourcemonitorModuleMXBean {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(eu.virtuwind.resourcemonitor.impl.AbstractResourcemonitorModule.class);
    ...
    public AbstractResourcemonitorModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public AbstractResourcemonitorModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractResourcemonitorModule oldModule,java.lang.AutoCloseable oldInstance) {
    ...
    public boolean canReuseInstance(AbstractResourcemonitorModule oldModule){
    ...
    public boolean isSame(AbstractResourcemonitorModule other) {
        if (other == null) {
    ...
    if (o == null || getClass() != o.getClass()) { return false; }
        AbstractResourcemonitorModule that = (AbstractResourcemonitorModule) o;
