...
public abstract class AbstractResourcemanagerModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractResourcemanagerModule> implements eu.virtuwind.resourcemanager.impl.ResourcemanagerModuleMXBean {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(eu.virtuwind.resourcemanager.impl.AbstractResourcemanagerModule.class);
    ...
    public AbstractResourcemanagerModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public AbstractResourcemanagerModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractResourcemanagerModule oldModule,java.lang.AutoCloseable oldInstance) {
    ...
    public boolean canReuseInstance(AbstractResourcemanagerModule oldModule){
    ...
    public boolean isSame(AbstractResourcemanagerModule other) {
        if (other == null) {
    ...
    if (o == null || getClass() != o.getClass()) { return false; }
        AbstractResourcemanagerModule that = (AbstractResourcemanagerModule) o;
